...
contextBridge.exposeInMainWorld("electron", {
    ...
    async getDesktopAgentStatus(): Promise<any> {
        return ipcRenderer.invoke("getDesktopAgentStatus");
    },
    async controlDesktopAgent(action: "start" | "restart"): Promise<any> {
        return ipcRenderer.invoke("controlDesktopAgent", action);
    },
});
